...
$passwordE1 = ConvertTo-SecureString "123123" -AsPlainText -Force 


$E1_VMWareCred = New-Object System.Management.Automation.PSCredential ("accc",$passwordE1)

Connect-VIServer -Server serv1 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv2 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv3 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv4 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv5 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv6 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv7 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv8 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv9 -Credential $E1_VMWareCred -ErrorAction SilentlyContinue

}

function Connect_E2_Vcenters{

$passwordE2 = ConvertTo-SecureString "321321321" -AsPlainText -Force


$E2_VMWareCred = New-Object System.Management.Automation.PSCredential ("accc2",$passwordE2)

Connect-VIServer -Server serv1 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv2 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv3 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv4 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv5 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv6 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv7 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
Connect-VIServer -Server serv8 -Credential $E2_VMWareCred -ErrorAction SilentlyContinue
